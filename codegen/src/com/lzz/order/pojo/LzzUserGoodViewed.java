...
*/
public class LzzUserGoodViewed {
	...
	public LzzUserGoodViewed(){};
	
	public LzzUserGoodViewed(LzzUserGoodViewed obj){
	    id = obj.getId();
	...
	public LzzUserGoodViewed clone(){
		LzzUserGoodViewed rslt = new LzzUserGoodViewed();
		rslt.id = this.getId();
	...
	public void constructWith(LzzUserGoodViewed pro) {
