...
public class LzzFileGroup {
	...
	public LzzFileGroup(LzzFileGroup obj){
	    id = obj.getId();

	    fileIds = obj.getFileIds();
	...
	public LzzFileGroup clone(){
		LzzFileGroup rslt = new LzzFileGroup();
		rslt.id = this.getId();

		rslt.fileIds = this.getFileIds();
	...
	public void constructWith(LzzFileGroup pro) {
		// TODO Auto-generated method stub
		this.id  = pro.getId ();

		this.fileIds  = pro.getFileIds ();
