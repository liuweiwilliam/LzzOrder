...
*/
public class LzzUserGoodInterested {
	...
	public LzzUserGoodInterested(){};
	
	public LzzUserGoodInterested(LzzUserGoodInterested obj){
	    id = obj.getId();
	...
	public LzzUserGoodInterested clone(){
		LzzUserGoodInterested rslt = new LzzUserGoodInterested();
		rslt.id = this.getId();
	...
	public void constructWith(LzzUserGoodInterested pro) {
