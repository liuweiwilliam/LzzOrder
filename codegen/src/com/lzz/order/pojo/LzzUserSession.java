...
session_key     小程序服务器返回的session_key
...
public class LzzUserSession {
	...
	public LzzUserSession(){};
	
	public LzzUserSession(LzzUserSession obj){
	    id = obj.getId();
	    ...
	    session_key = obj.getSession_key();

	    validTime = obj.getValidTime();
	...
	public LzzUserSession clone(){
		LzzUserSession rslt = new LzzUserSession();
		rslt.id = this.getId();

		rslt.sessionId = this.getSessionId();

		rslt.userId = this.getUserId();

		rslt.session_key = this.getSession_key();

		rslt.validTime = this.getValidTime();
	...
	public void constructWith(LzzUserSession pro) {
		// TODO Auto-generated method stub
		this.id  = pro.getId ();

		this.sessionId  = pro.getSessionId ();

		this.userId  = pro.getUserId ();

		this.session_key  = pro.getSession_key ();

		this.validTime  = pro.getValidTime ();
