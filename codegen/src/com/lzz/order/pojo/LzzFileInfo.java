...
public class LzzFileInfo {
	...
	public LzzFileInfo(LzzFileInfo obj){
	    id = obj.getId();
	    ...
	    fsavepath = obj.getFsavepath();

	    furlpath = obj.getFurlpath();
	...
	public LzzFileInfo clone(){
		LzzFileInfo rslt = new LzzFileInfo();
		rslt.id = this.getId();
		...
		rslt.fsavepath = this.getFsavepath();

		rslt.furlpath = this.getFurlpath();
