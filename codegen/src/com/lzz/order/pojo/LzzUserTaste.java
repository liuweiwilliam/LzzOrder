...
public class LzzUserTaste {
	...
	public LzzUserTaste(LzzUserTaste obj){
	    id = obj.getId();
	...
	public LzzUserTaste clone(){
		LzzUserTaste rslt = new LzzUserTaste();
		rslt.id = this.getId();
	...
	public void constructWith(LzzUserTaste pro) {
