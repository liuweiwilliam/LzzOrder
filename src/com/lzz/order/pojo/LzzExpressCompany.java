...
*/
public class LzzExpressCompany {
	...
	public LzzExpressCompany(){};
	
	public LzzExpressCompany(LzzExpressCompany obj){
	    id = obj.getId();
	...
	public LzzExpressCompany clone(){
		LzzExpressCompany rslt = new LzzExpressCompany();
		rslt.id = this.getId();
	...
	public void constructWith(LzzExpressCompany pro) {
