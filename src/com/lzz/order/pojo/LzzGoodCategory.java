...
public class LzzGoodCategory {
	...
	public LzzGoodCategory(){};
	
	public LzzGoodCategory(LzzGoodCategory obj){
	    id = obj.getId();
	...
	public LzzGoodCategory clone(){
		LzzGoodCategory rslt = new LzzGoodCategory();
		rslt.id = this.getId();

		rslt.goodId = this.getGoodId();

		rslt.categoryId = this.getCategoryId();
	...
	public void constructWith(LzzGoodCategory pro) {
