...
public class LzzUserCoupon {
	...
	public LzzUserCoupon(){};
	
	public LzzUserCoupon(LzzUserCoupon obj){
	    id = obj.getId();
	...
	public LzzUserCoupon clone(){
		LzzUserCoupon rslt = new LzzUserCoupon();
		rslt.id = this.getId();
	...
	public void constructWith(LzzUserCoupon pro) {
