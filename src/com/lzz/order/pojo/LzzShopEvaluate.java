...
public class LzzShopEvaluate {
	...
	public LzzShopEvaluate(){};
	
	public LzzShopEvaluate(LzzShopEvaluate obj){
	    id = obj.getId();
	...
	public LzzShopEvaluate clone(){
		LzzShopEvaluate rslt = new LzzShopEvaluate();
		rslt.id = this.getId();
	...
	public void constructWith(LzzShopEvaluate pro) {
