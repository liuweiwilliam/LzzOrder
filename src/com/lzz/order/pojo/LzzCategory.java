...
public class LzzCategory {
	...
	public LzzCategory(LzzCategory obj){
	    id = obj.getId();
	...
	public LzzCategory clone(){
		LzzCategory rslt = new LzzCategory();
		rslt.id = this.getId();
	...
	public void constructWith(LzzCategory pro) {
