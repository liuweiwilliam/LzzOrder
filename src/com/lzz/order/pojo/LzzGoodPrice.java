...
public class LzzGoodPrice {
	...
	public LzzGoodPrice(LzzGoodPrice obj){
	    id = obj.getId();
	...
	public LzzGoodPrice clone(){
		LzzGoodPrice rslt = new LzzGoodPrice();
		rslt.id = this.getId();
	...
	public void constructWith(LzzGoodPrice pro) {
